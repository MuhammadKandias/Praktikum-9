...
//ketika method POST dijalankan
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	//Jenis Pendaftaran nya
	if(empty($_POST["jenis_pendaftaran"])){
		...
		elseif($jenis_pendaftaran == "02"){
			...
			$error_jenis_pendaftaran="Masukkan pilihan jenis pendaftaran anda dengan benar!";
		}
	}
...
//tampilkan pesan sukses jika sudah berhasil menyimpan data
echo $pesan_sukses;
?>
<center><button onclick="location.href = 'cetakexcel.php';" id="cetak" class="btn btn-warning" >Buat File Excel</button></center>
</body>
</html>